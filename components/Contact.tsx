      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '72px 32px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(300px,1fr))', gap: 52, alignItems: 'stretch' }}>
          ...
          <div id="contact-col">
            ...
            <a href="tel:+441234567890" className="contact-row contact-anim">
              ...
              <div>
                ...
                <div className="c-val">[ Your phone number ]</div>
              </div>
            </a>

            <a href="mailto:hello@lussoexecutivetravel.co.uk" className="contact-row contact-anim">
              <div className="c-icon">
              ...
              <div>
                ...
                <div className="c-val">[ Your email address ]</div>
              </div>
            </a>

            <a href="https://wa.me/447700000000" target="_blank" rel="noopener noreferrer" className="contact-row contact-anim">
